...
6. **🌐 网页版配置** ✨ - 全新的Web界面，支持密码保护的在线配置管理
...
- [🌐 网页版快速开始](#-网页版快速开始) ✨
- [☁️ 云端部署 (claw.cloud)](#-云端部署-clawcloud) 🌍
- [本地部署](#-本地部署) 🏠
- [Docker部署](#-docker部署) 🐳
- [配置变量说明](#-配置变量说明) ⚙️
...
# 复制配置文件并编辑GitHub Token
cp env.example .env
# 编辑 .env 文件，配置 GITHUB_TOKENS=your_tokens_here
...
> 📖 **详细文档**: [网页版配置指南](docs/WEB_SETUP.md)
...
- ✅ **Kubernetes原生** - 完整的K8s部署配置
- ✅ **自动SSL证书** - Let's Encrypt自动证书管理
- ✅ **监控告警** - Prometheus + Grafana监控
- ✅ **日志聚合** - 集中化日志收集和分析
- ✅ **备份恢复** - 自动数据备份和恢复

> 📖 **详细指南**: [Claw.cloud部署文档](docs/CLAW_CLOUD_DEPLOYMENT.md) | [快速开始](CLAW_CLOUD_QUICK_START.md)
...
services:
  hajimi-king:
    ...
    environment:
      ...
      # 网页配置
      - WEB_PASSWORD=your_secure_password  # 修改默认密码
